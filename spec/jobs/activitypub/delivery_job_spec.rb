...
RSpec.describe ActivityPub::DeliveryJob do
  ...
  before do
    allow_any_instance_of(Account).to receive(:remote_followers_hash).with('https://example.com/api').and_return('somehash') # rubocop:disable RSpec/AnyInstance
  end
